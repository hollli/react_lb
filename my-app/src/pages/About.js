                ...
                <Row>
                    <Col sm={3}>
                        <Nav variant="pills" className="flex-column mt-2">
                            <Nav.Item>
                                <Nav.Link id="Developers"
                                          eventKey="first">{context.language === "eu" ? "Developers" : "Розробники"} </Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link eventKey="second">{context.language === "eu" ? "Team" : "Команда"}</Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link id="Marketers" eventKey="third">{context.language === "eu" ? "Marketers" : "Маркетологи"}</Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link id="Naturalists" eventKey="fourth">{context.language === "eu" ? "Naturalists" : "Натуралісти"}</Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link eventKey="fifth">{context.language === "eu" ? "Library" : "Бібліотека"}</Nav.Link>
                            </Nav.Item>
                        </Nav>
                    </Col>
                    <Col sm={9}>
